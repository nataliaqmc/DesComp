...
-- PC_OUT[1]	=>  Location: PIN_U1,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- PC_OUT[2]	=>  Location: PIN_W2,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- LEDR[0]	=>  Location: PIN_Y3,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- LEDR[1]	=>  Location: PIN_N2,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- LEDR[2]	=>  Location: PIN_N1,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- LEDR[3]	=>  Location: PIN_R5,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- LEDR[4]	=>  Location: PIN_M21,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- LEDR[5]	=>  Location: PIN_D9,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- LEDR[6]	=>  Location: PIN_P6,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- SW[0]	=>  Location: PIN_C2,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SW[1]	=>  Location: PIN_C1,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SW[2]	=>  Location: PIN_L1,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- SW[8]	=>  Location: PIN_G1,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \ULA1|Add0~18_cout\ = CARRY(( (\PC|DOUT[2]~DUPLICATE_q\ & ((\PC|DOUT\(1)) # (\PC|DOUT\(0)))) ) + ( VCC ) + ( !VCC ))
...
-- Equation(s):
-- \ULA1|Add0~1_sumout\ = SUM(( \REGA|DOUT\(0) ) + ( !\SW[6]~input_o\ $ (((!\PC|DOUT[2]~DUPLICATE_q\) # ((!\PC|DOUT\(0) & !\PC|DOUT[1]~DUPLICATE_q\)))) ) + ( \ULA1|Add0~18_cout\ ))
-- \ULA1|Add0~2\ = CARRY(( \REGA|DOUT\(0) ) + ( !\SW[6]~input_o\ $ (((!\PC|DOUT[2]~DUPLICATE_q\) # ((!\PC|DOUT\(0) & !\PC|DOUT[1]~DUPLICATE_q\)))) ) + ( \ULA1|Add0~18_cout\ ))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000111011000001001100000000000000000000000011111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \PC|ALT_INV_DOUT\(0),
...
-- Equation(s):
-- \ROM1|memROM~1_combout\ = ( !\PC|DOUT\(0) & ( !\PC|DOUT\(1) & ( !\PC|DOUT[2]~DUPLICATE_q\ ) ) )
...
-- Equation(s):
-- \ROM1|memROM~0_combout\ = ( \PC|DOUT[2]~DUPLICATE_q\ & ( (!\PC|DOUT\(0) & !\PC|DOUT[1]~DUPLICATE_q\) ) ) # ( !\PC|DOUT[2]~DUPLICATE_q\ )
...
-- Equation(s):
-- \ROM1|memROM~2_combout\ = ( !\PC|DOUT[1]~DUPLICATE_q\ & ( \PC|DOUT\(2) & ( !\PC|DOUT\(0) ) ) ) # ( \PC|DOUT[1]~DUPLICATE_q\ & ( !\PC|DOUT\(2) ) ) # ( !\PC|DOUT[1]~DUPLICATE_q\ & ( !\PC|DOUT\(2) & ( \PC|DOUT\(0) ) ) )
...
-- Equation(s):
-- \ULA1|Add0~5_sumout\ = SUM(( \REGA|DOUT\(1) ) + ( !\SW[7]~input_o\ $ (((!\PC|DOUT[2]~DUPLICATE_q\) # ((!\PC|DOUT\(0) & !\PC|DOUT\(1))))) ) + ( \ULA1|Add0~2\ ))
-- \ULA1|Add0~6\ = CARRY(( \REGA|DOUT\(1) ) + ( !\SW[7]~input_o\ $ (((!\PC|DOUT[2]~DUPLICATE_q\) # ((!\PC|DOUT\(0) & !\PC|DOUT\(1))))) ) + ( \ULA1|Add0~2\ ))
...
-- Equation(s):
-- \ULA1|Add0~9_sumout\ = SUM(( \REGA|DOUT\(2) ) + ( !\SW[8]~input_o\ $ (((!\PC|DOUT[2]~DUPLICATE_q\) # ((!\PC|DOUT\(0) & !\PC|DOUT[1]~DUPLICATE_q\)))) ) + ( \ULA1|Add0~6\ ))
-- \ULA1|Add0~10\ = CARRY(( \REGA|DOUT\(2) ) + ( !\SW[8]~input_o\ $ (((!\PC|DOUT[2]~DUPLICATE_q\) # ((!\PC|DOUT\(0) & !\PC|DOUT[1]~DUPLICATE_q\)))) ) + ( \ULA1|Add0~6\ ))
...
-- Equation(s):
-- \ULA1|Add0~13_sumout\ = SUM(( \REGA|DOUT\(3) ) + ( !\SW[9]~input_o\ $ (((!\PC|DOUT\(2)) # ((!\PC|DOUT\(0) & !\PC|DOUT[1]~DUPLICATE_q\)))) ) + ( \ULA1|Add0~10\ ))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000111110000000011100000000000000000000000011111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \PC|ALT_INV_DOUT\(0),
