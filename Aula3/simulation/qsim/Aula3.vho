...
SIGNAL \DEC|saida[1]~1_combout\ : std_logic;
SIGNAL \DEC|saida[2]~2_combout\ : std_logic;
...
SIGNAL \DEC|saida[0]~0_combout\ : std_logic;
...
SIGNAL \DEC|ALT_INV_saida[1]~1_combout\ : std_logic;
...
\DEC|ALT_INV_saida[1]~1_combout\ <= NOT \DEC|saida[1]~1_combout\;
...
\DEC|saida[1]~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \DEC|saida[1]~1_combout\ = ( !\PC|DOUT\(0) & ( !\PC|DOUT\(1) & ( !\PC|DOUT[2]~DUPLICATE_q\ ) ) )
...
PORT MAP (
	...
	combout => \DEC|saida[1]~1_combout\);

-- Location: LABCELL_X1_Y19_N48
\DEC|saida[2]~2\ : cyclonev_lcell_comb
-- Equation(s):
-- \DEC|saida[2]~2_combout\ = ( \PC|DOUT[1]~DUPLICATE_q\ & ( \PC|DOUT[0]~DUPLICATE_q\ & ( !\PC|DOUT\(2) ) ) ) # ( !\PC|DOUT[1]~DUPLICATE_q\ & ( \PC|DOUT[0]~DUPLICATE_q\ & ( !\PC|DOUT\(2) ) ) ) # ( \PC|DOUT[1]~DUPLICATE_q\ & ( !\PC|DOUT[0]~DUPLICATE_q\ & ( 
...
PORT MAP (
	...
	clrn => \DEC|ALT_INV_saida[1]~1_combout\,
	ena => \DEC|saida[2]~2_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \REGA|DOUT\(0));
...
\DEC|saida[0]~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \DEC|saida[0]~0_combout\ = (!\PC|DOUT\(2) & ((\PC|DOUT[0]~DUPLICATE_q\) # (\PC|DOUT[1]~DUPLICATE_q\)))
